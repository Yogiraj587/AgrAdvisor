fertiliser_info = {
    'NHigh': """
        The N of soil os high and might give rise to weeds.
        <br/> These are the measures you have to take: 
        ...
        <br/>5. <i>Use much (wet grass) while growing crops</i> - Mulch can also include sawdust and scrap soft woods.""",
